...
class RLS_demo(Scene):
    def construct(self):
        ...
        self.wait(0.5)
        sym_muscle = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\leg_1f9b5.png").scale(0.8).shift(6*DOWN)
        self.add(sym_muscle)
        self.play(sym_muscle.animate.shift(UP*4.5))
        sym_ache = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\high-voltage-sign_26a1.png").scale(0.6)
        sym_fire = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\fire_1f525.png").scale(0.6)
        sym_sting = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\collision_1f4a5.png").scale(0.6)
        def twinkle(mobg):
        ...
        sym_sleep = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\person-in-bed_light-skin-tone_1f6cc-1f3fb_1f3fb.png").shift(DOWN)
        sym_fbid = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\zzz_1f4a4.png").shift(DOWN+RIGHT)
        sym_anger = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\person-in-bed_anger.png").shift(DOWN)
        self.wait()
        ...
        sym_rest = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\chair_1fa91.png").shift(0.5*DOWN+3*LEFT).scale(0.5)
        sym_restman = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\anxious-face-with-sweat_1f630.png").shift(2*DOWN+3*LEFT)
        sym_sport = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\motorway_1f6e3-fe0f.png").scale(0.4).shift(0.5*DOWN)
        sym_sportman = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\hugging-face_1f917.png").shift(2*DOWN).scale(0.3)
        sym_night = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\night-with-stars_1f303.png").shift(0.5*DOWN+3*RIGHT).scale(0.4)
        sym_nightman = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\loudly-crying-face_1f62d.png").shift(2*DOWN+3*RIGHT)
        ...
        sym_think = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\thinking-face_1f914.png").shift(DOWN)
        sym_why = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\question-mark_2753.png").next_to(sym_think, UR, buff=-0.25)
        ...
        sym_annoy = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s2\\confounded-face_1f616.png").shift(DOWN).scale(1.5)
        ...
        self.wait(0.4)
        ease_muscle = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3\\leg_1f9b5.png").scale(0.8).shift(2*DOWN)
        self.play(FadeIn(ease_muscle, shift=UP))
        ease_hand1 = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3\\hand-with-fingers-splayed_1f590-fe0f.png").scale(0.6).shift(6*DOWN+RIGHT)
        self.play(ease_hand1.animate.next_to(ease_muscle, RIGHT, buff=0))
        ease_hand2 = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3\\waving-hand_1f44b.png").scale(0.6).next_to(ease_muscle, RIGHT, buff=0)
        ...
        path_list = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3.5\\clipboard_1f4cb.png").scale(2).shift(DOWN+3.5*LEFT)
        path_glass1 = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3.5\\magnifying-glass-tilted-left_1f50d.png").scale(0.5).move_to(path_list).shift(RIGHT+0.3*UP)
        path_glass2 = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3.5\\magnifying-glass-tilted-right_1f50e.png").scale(1.2).move_to(path_list).shift(0.5*DOWN+0.7*LEFT)
        ...
        path_old = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3.5\\old-man_1f474.png").scale(1.2).shift(DOWN+4.3*LEFT)
        path_man = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3.5\\man_1f468.png").scale(1.2).shift(DOWN+3.5*LEFT)
        path_baby = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3.5\\baby_1f476.png").scale(1.2).shift(DOWN+2.7*LEFT)
        self.play(
            LaggedStart(
        ...
        path_Fe = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3.5\\symbol-element-iron-Fe.png").scale(0.4).shift(1.5*DOWN+1.5*RIGHT)
        path_drug = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3.5\\drugs.png").scale(0.4).shift(1.5*DOWN+3.5*RIGHT)
        path_nerve = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s3.5\\brain-stroke-100.png").scale(2.2).shift(1.5*DOWN+5.5*RIGHT)
        ...
        cure_hosp = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\hospital_1f3e5.png").scale(3).to_edge(DOWN).shift(2.5*LEFT)
        cure_doc = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\woman-health-worker_1f469-200d-2695-fe0f.png").scale(1.6).to_edge(DOWN).shift(LEFT)
        cure_pat = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\hushed-face_1f62f.png").scale(1.1).move_to(cure_doc).shift(2.5*RIGHT)
        cure_syr = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\syringe_1f489.png").scale(0.8).move_to(cure_doc).shift(2.5*DOWN+0.8*RIGHT)
        ...
        self.wait()
        cure_massage = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\two_hands.png").scale(0.6)
        cure_walk = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\person-walking_1f6b6.png").scale(0.3)
        cure_play = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\video-game_1f3ae.png").scale(0.6)
        cure_puzzle = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\puzzle-piece_1f9e9.png").scale(0.6)
        cure_shower = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\shower_1f6bf.png").scale(0.8)
        ...
        cure_good = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\thumbs-up_1f44d.png").scale(1.2).move_to(cure_r1).shift(0.2*LEFT)
        cure_ok = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\ok-hand_1f44c.png").scale(1.2).move_to(cure_r2).shift(0.2*RIGHT)
        ...
        cure_med1 = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\900.png").scale(0.5).shift(8*LEFT+0.5*DOWN)
        cure_med2 = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s4\\Gabapentin-Enacarbil_Conformer3D_large.png").scale(1.1).shift(10*RIGHT+0.5*DOWN)
        self.wait()
        self.add(cure_med1)
        ...
        mis_leg = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s5\\person-standing_1f9cd_leg.png").scale(1.5).move_to([-2,1,0])
        cor_body = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s5\\person-standing_1f9cd.png", z_index=-1).scale(1.5).to_edge(DOWN, buff=0.5)
        ...
        mis_man1 = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s5\\face-with-steam-from-nose_1f624.png").shift(5.25*LEFT)
        cor_man1 = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s5\\grinning-squinting-face_1f606.png").shift(1.75*RIGHT)
        mis_point = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s5\\index-pointing-up_261d-fe0f.png").next_to(mis_man1, RIGHT)
        cor_thumb = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s5\\thumbs-up_1f44d.png").scale(0.8).next_to(cor_man1, RIGHT)
        mis_pill = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s5\\pill_1f48a.png").next_to(mis_point, RIGHT)
        mis_lancet = ImageMobject("C:\\Users\\28295\\Desktop\\24春\\神经系统\\小组作业\\素材\\s5\\vector-medical-surgery-scalpel-tool.png").scale(0.4).next_to(mis_pill, RIGHT).shift(1.2*LEFT)
